package org.example.system.aspect;
...
import org.example.system.annotation.Log;
...
public class LogAspect {
     ...
     * @param joinPoint 切点
     */
    //pointcut和afterReturning一起完成日志记录
    //pointcut 属性用于指定切入点表达式，决定了在哪些方法上执行切面逻辑。
    //@annotation(controllerLog) 表达式是一个切入点表达式，
    //它使用 @annotation 来匹配带有特定注解的方法。具体来说， 在此处匹配带有@Log的方法
    // 它会匹配那些被 controllerLog 注解修饰的方法。
